      ...
      packages: [
        {
          ...
          priceNote: '/projeto',
          highlights: [
            '4 vídeos criados com IA prontos pra postar',
            'Pronto pra Reels, Stories ou TikTok',
            'Legenda embutida pra quem assiste sem som',
            'Identidade visual da sua marca em cada vídeo',
          ],
          extras: [
            '4 vídeos de até 30 segundos',
            '1 revisão gratuita por vídeo',
          ...
          howItWorks: {
            steps: [
              ...
              'Geramos os 4 vídeos com IA (Higgsfield)',
              'Adicionamos legenda e identidade visual da marca',
              '1 revisão por vídeo inclusa — entrega em MP4 otimizado',
            ],
        ...
        },
        {
          ...
          highlights: [
            ...
            'Color grading pra deixar a imagem com cara de produção cara',
            'Gerado com IA e finalizado com edição profissional',
          ],
          extras: [
            '5 vídeos curtos pra redes derivados do principal',
          ...
          howItWorks: {
            steps: [
              ...
              'Geração com IA (Higgsfield) + edição profissional',
              'Motion graphics: títulos animados, transições e logo em movimento',
